import React, { useState, signOut } from 'react'
...
const Login = () => {
    ...
    return (
        <div className='container mx-[600px] max-h-screen'>
            <div className="w-full my-auto max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
                ...
                <form novalidate="" action="" className="space-y-6">
                    ...
                    {user ? <button onClick={() => handleSignOut()} className="block w-full p-3 text-center dark:text-gray-900 dark:bg-violet-400 rounded-lg">Sign out</button> : <button className="block w-full p-3 text-center dark:text-gray-900 dark:bg-violet-400 rounded-lg">Sign in</button>}
                    {/* <button className="block w-full p-3 text-center dark:text-gray-900 dark:bg-violet-400 rounded-lg">Sign in</button> */}
            ...
            {user && <div className="card w-96 bg-base-100 shadow-xl my-16">
